                        ...
                        <c:forEach var="user" items="${users}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="${pageContext.request.contextPath}/user/delete/${user.maNd}" method="post" class="d-inline delete-confirm-form" data-delete-message="Bạn có chắc chắn muốn xóa nhân viên này?">
