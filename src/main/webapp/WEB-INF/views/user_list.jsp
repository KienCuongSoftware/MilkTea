                        ...
                        <c:forEach var="user" items="${users}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="${pageContext.request.contextPath}/user/delete/${user.maNd}" method="post" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa nhân viên này?');">
