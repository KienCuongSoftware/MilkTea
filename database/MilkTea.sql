...
/* ngaydat dung DATE_SUB(NOW(), INTERVAL n DAY) de khi chay script tu dong tinh theo thoi diem chay - don status=3 la da thanh toan (hoan thanh) */
INSERT INTO `don_hang` (`id`,`MaND`,`ten`,`diachi`,`sdt`,`ngaydat`,`voucher`,`tongTien`,`status`,`discount_amount`,`discount_type`,`discount_value`) VALUES
(1,NULL,'Nguyễn Thị Mai','123 Đường Láng, Đống Đa, Hà Nội','0987654321',DATE_SUB(NOW(), INTERVAL 0 DAY),'NEWCUST10',459000,3,NULL,NULL,NULL),
(2,NULL,'Trần Văn An','456 Minh Khai, Hai Bà Trưng, Hà Nội','0912345678',DATE_SUB(NOW(), INTERVAL 1 DAY),NULL,115000,0,NULL,NULL,NULL),
(3,NULL,'Lê Hoàng','12A Nguyễn Trãi, Thanh Xuân, Hà Nội','0901122334',DATE_SUB(NOW(), INTERVAL 1 DAY),NULL,49000,3,NULL,NULL,NULL),
(4,NULL,'Phạm Quỳnh Trang','89 Phố Huế, Hoàn Kiếm, Hà Nội','0977888999',DATE_SUB(NOW(), INTERVAL 2 DAY),'VIP30',476000,3,NULL,NULL,NULL),
(5,NULL,'Đỗ Minh Đức','27 Kim Mã, Ba Đình, Hà Nội','0988997766',DATE_SUB(NOW(), INTERVAL 2 DAY),NULL,54000,0,NULL,NULL,NULL),
(6,NULL,'Hoàng Anh','Số 9, Trần Duy Hưng, Cầu Giấy, Hà Nội','0966668888',DATE_SUB(NOW(), INTERVAL 2 DAY),NULL,34000,0,NULL,NULL,NULL),
(7,NULL,'Nguyễn Văn An','123 Đường Láng, Đống Đa, Hà Nội','0987654321',DATE_SUB(NOW(), INTERVAL 3 DAY),'NEWCUST10',135000,3,15000.00,'PERCENT',10.00),
(8,NULL,'Trần Thị Bình','456 Minh Khai, Hai Bà Trưng, Hà Nội','0912345678',DATE_SUB(NOW(), INTERVAL 3 DAY),'SUMMER15',204000,3,36000.00,'PERCENT',15.00),
(9,NULL,'Lê Văn Cường','789 Nguyễn Trãi, Thanh Xuân, Hà Nội','0901122334',DATE_SUB(NOW(), INTERVAL 4 DAY),'VIP30',245000,1,NULL,NULL,NULL),
(10,NULL,'Phạm Thị Dung','321 Kim Mã, Ba Đình, Hà Nội','0977888999',DATE_SUB(NOW(), INTERVAL 4 DAY),'FLASH100K',180000,3,100000.00,'VALUE',100000.00),
(11,NULL,'Hoàng Văn Em','654 Trần Duy Hưng, Cầu Giấy, Hà Nội','0988997766',DATE_SUB(NOW(), INTERVAL 4 DAY),'FLASH100K',150000,3,100000.00,'VALUE',100000.00),
(12,NULL,'Đỗ Thị Phương','987 Phố Huế, Hoàn Kiếm, Hà Nội','0966668888',DATE_SUB(NOW(), INTERVAL 5 DAY),NULL,115000,2,NULL,NULL,NULL),
(13,NULL,'Nguyễn Văn Giang','147 Lê Văn Lương, Thanh Xuân, Hà Nội','0955557777',DATE_SUB(NOW(), INTERVAL 5 DAY),NULL,95000,3,NULL,NULL,NULL),
(14,NULL,'Trần Thị Hương','258 Đội Cấn, Ba Đình, Hà Nội','0944446666',DATE_SUB(NOW(), INTERVAL 5 DAY),NULL,145000,2,NULL,NULL,NULL),
(15,NULL,'Lê Văn Hùng','369 Nguyễn Khang, Cầu Giấy, Hà Nội','0933335555',DATE_SUB(NOW(), INTERVAL 6 DAY),NULL,125000,3,NULL,NULL,NULL),
(16,NULL,'Phạm Thị Khanh','741 Láng Hạ, Đống Đa, Hà Nội','0922224444',DATE_SUB(NOW(), INTERVAL 6 DAY),NULL,165000,2,NULL,NULL,NULL),
(17,NULL,'Hoàng Văn Long','852 Nguyễn Chí Thanh, Đống Đa, Hà Nội','0911113333',DATE_SUB(NOW(), INTERVAL 6 DAY),NULL,135000,3,NULL,NULL,NULL),
(18,NULL,'Đỗ Thị Mai','963 Đại Cồ Việt, Hai Bà Trưng, Hà Nội','0900002222',DATE_SUB(NOW(), INTERVAL 7 DAY),NULL,155000,3,NULL,NULL,NULL),
(19,NULL,'Nguyễn Văn Nam','159 Tây Sơn, Đống Đa, Hà Nội','0899991111',DATE_SUB(NOW(), INTERVAL 7 DAY),NULL,175000,1,NULL,NULL,NULL),
(20,NULL,'Trần Thị Oanh','357 Nguyễn Văn Cừ, Long Biên, Hà Nội','0888880000',DATE_SUB(NOW(), INTERVAL 1 DAY),NULL,195000,2,NULL,NULL,NULL),
(21,NULL,'Lê Văn Phúc','753 Nguyễn Văn Linh, Long Biên, Hà Nội','0877779999',DATE_SUB(NOW(), INTERVAL 0 DAY),NULL,185000,3,NULL,NULL,NULL),
(22,NULL,'Phạm Thị Quỳnh','951 Nguyễn Văn Huyên, Cầu Giấy, Hà Nội','0866668888',DATE_SUB(NOW(), INTERVAL 2 DAY),NULL,205000,1,NULL,NULL,NULL),
(23,NULL,'Hoàng Văn Rạng','852 Nguyễn Văn Huyên, Cầu Giấy, Hà Nội','0855557777',DATE_SUB(NOW(), INTERVAL 3 DAY),NULL,215000,0,NULL,NULL,NULL),
(24,NULL,'Đỗ Thị Sương','741 Nguyễn Văn Huyên, Cầu Giấy, Hà Nội','0844446666',DATE_SUB(NOW(), INTERVAL 4 DAY),NULL,225000,3,NULL,NULL,NULL),
(25,NULL,'Nguyễn Văn Tú','963 Nguyễn Văn Huyên, Cầu Giấy, Hà Nội','0833335555',DATE_SUB(NOW(), INTERVAL 5 DAY),NULL,235000,2,NULL,NULL,NULL);
